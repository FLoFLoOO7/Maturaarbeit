...
def Pll_V2(x,executed ):
    ...
    while True:
        ...
        if final_kanten in PLL_kanten:
            ...
            executed.extend(moves)
            for m in moves:            # <-- sofort anwenden
                x = move_fn[m](x)
            break
        else:
            x = B(x)                    # rotiere Ansicht
            executed.append('B')
            spins += 1
            if spins == 4:              # Sicherheitsnetz
                break
    ...
    while True:
        ...
        if final_ecken in PLLL:
            ...
            executed.extend(moves)
            for m in moves:            # <-- ebenfalls sofort anwenden
                x = move_fn[m](x)
            break
        else:
            x = B(x)
...
def ausfuhren(g):
    ...
    x,executed=kreuz_V5(g)
    print(executed)
    Form,executed=ecken_f2l(x,executed)
    print(executed)
    x,executed=kanten_f2l(Form,executed)
    print(executed)
    Form,executed=Oll(x,executed)
    print(executed)
    final=Pll_V2(Form,executed)
    print(final)
ausfuhren(g)
