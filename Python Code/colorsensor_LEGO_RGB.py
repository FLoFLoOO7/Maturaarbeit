...
for side_num in range(6):        
    ...
    mootor_color.run_angle(1000, 180)    # Sensor zurück
    ...
    for i in range(8):
        ...
        motoro.run_angle(800, 45)  #gegen den uhrzeigersinn      

    cube_faces.append(current_face)


    # Sensor ganz zurückfahren rot
    mootor_color.run_angle(1000, 200)
    if side_num==3:
